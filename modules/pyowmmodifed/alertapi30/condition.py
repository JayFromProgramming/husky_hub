...
class Condition:
    ...
    Allowed weather params and operators are specified by the `pyowmmodifed.utils.alertapi30.WeatherParametersEnum` and
    `pyowmmodifed.utils.alertapi30.OperatorsEnum` enumerator classes.
