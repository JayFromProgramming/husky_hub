...
class Trigger:
    ...
    `pyowmmodifed.utils.alertapi30.AlertManager` instance.
    ...
    to `None`
    :type alerts: list of `pyowmmodifed.utils.alertapi30.Alert` instances
    ...
    def get_alerts_on(self, weather_param):
        ...
        `pyowmmodifed.alertapi30.enums.WeatherParametersEnum`
        :param weather_param: str, values in `pyowmmodifed.alertapi30.enums.WeatherParametersEnum`
        :return: list of `Alert` instances
        """
        result = []
        for alert in self.alerts:
