...
class AlertManager:
    ...
    def create_trigger(self,  start, end, conditions, area, alert_channels=None):
        ...
        :type conditions: list of `pyowmmodifed.utils.alertapi30.Condition` instances
        ...
        :type alert_channels: list of `pyowmmodifed.utils.alertapi30.AlertChannel` instances
    ...
    def get_triggers(self):
        ...
        :returns: list of `pyowmmodifed.alertapi30.trigger.Trigger` objects
    ...
    def get_trigger(self, trigger_id):
        ...
        :type trigger_id: str
        :return: a `pyowmmodifed.alertapi30.trigger.Trigger` instance
        """
    ...
    def delete_trigger(self, trigger):
        ...
        `pyowmmodifed.alertapi30.trigger.Trigger`, along with all related alerts

        :param trigger: the `pyowmmodifed.alertapi30.trigger.Trigger` object to be deleted
        :type trigger: `pyowm.alertapi30.trigger.Trigger`
    ...
    def get_alerts_for(self, trigger):
        ...
        :type trigger: `pyowm.alertapi30.trigger.Trigger`
        :return: list of `pyowmmodifed.alertapi30.alert.Alert` objects
        """
        assert trigger is not None
        assert isinstance(trigger.id, str), "Value must be a string"
        status, data = self.http_client.get_json(
    ...
    def get_alert(self, alert_id, trigger):
        ...
        :return: an `pyowmmodifed.alertapi30.alert.Alert` instance
        """
        assert trigger is not None
