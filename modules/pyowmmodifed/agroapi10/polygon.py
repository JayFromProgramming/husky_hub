...
class Polygon:
    ...
    :type namr: str
    :param geopolygon: the `pyowmmodifed.utils.geo.Polygon` instance that represents this polygon
    :type geopolygon: `pyowm.utils.geo.Polygon`
    :param center: the `pyowmmodifed.utils.geo.Point` instance that represents the central point of the polygon
