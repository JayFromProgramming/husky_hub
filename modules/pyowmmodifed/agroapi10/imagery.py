...
class MetaImage:
    ...
    :type url: str
    :param preset: the preset of the image (supported values are listed by `pyowmmodifed.agroapi10.enums.PresetEnum`)
    :type preset: str
    :param satellite_name: the name of the satellite that acquired the image (supported values are listed
        by `pyowmmodifed.agroapi10.enums.SatelliteEnum`)
...
class SatelliteImage:
    ...
    :type metadata: a `pyowmmodifed.agro10.imagery.MetaImage` subtype instance
    :param data: the actual data for this satellite image
    :type data: either `pyowmmodifed.commons.image.Image` or `pyowmmodifed.commons.tile.Tile` object
    ...
    :returns: a `pyowmmodifed.agroapi10.imagery.SatelliteImage` instance
    """
