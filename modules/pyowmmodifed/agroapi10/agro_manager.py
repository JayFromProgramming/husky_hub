...
class AgroManager:
    ...
    def create_polygon(self, geopolygon, name=None):
        ...
        :type geopolygon: `pyowmmodifed.utils.geo.Polygon` instance
        :param name: optional mnemonic name for the new polygon
        :type name: str
        :return: a `pyowmmodifed.agro10.polygon.Polygon` instance
        """
    ...
    def get_polygons(self):
        ...
        :returns: list of `pyowmmodifed.agro10.polygon.Polygon` objects
    ...
    def get_polygon(self, polygon_id):
        ...
        :type id: str
        :returns: a `pyowmmodifed.agro10.polygon.Polygon` object
    ...
    def update_polygon(self, polygon):
        ...
        :param polygon: the `pyowmmodifed.agro10.polygon.Polygon` object to be updated
        :type polygon: `pyowmmodifed.agro10.polygon.Polygon` instance
    ...
    def delete_polygon(self, polygon):
        ...
        :param polygon: the `pyowmmodifed.agro10.polygon.Polygon` object to be deleted
        :type polygon: `pyowmmodifed.agro10.polygon.Polygon` instance
    ...
    def soil_data(self, polygon):
        ...
        :type polygon: `pyowmmodifed.agro10.polygon.Polygon` instance
        :returns: a `pyowmmodifed.agro10.soil.Soil` instance
    ...
    def search_satellite_imagery(self, polygon_id, acquired_from, acquired_to, img_type=None, preset=None,
        ...
        :param img_type: the desired file format type of the images. Allowed values are given by `pyowmmodifed.commons.enums.ImageTypeEnum`
        :type img_type: `pyowm.commons.databoxes.ImageType`
        :param preset: the desired preset of the images. Allowed values are given by `pyowmmodifed.agroapi10.enums.PresetEnum`
        :type preset: str
        ...
        :return: a list of `pyowmmodifed.agro10.imagery.MetaImage` subtypes instances
        """
    ...
    def download_satellite_image(self, metaimage, x=None, y=None, zoom=None, palette=None):
        ...
        :type metaimage: a `pyowmmodifed.agroapi10.imagery.MetaImage` subtype
        ...
        :param palette: ID of the color palette of the downloaded images. Values are provided by `pyowmmodifed.agroapi10.enums.PaletteEnum`
        :type palette: str or `None`
        :return: a `pyowmmodifed.agroapi10.imagery.SatelliteImage` instance containing both image's metadata and data
        """
