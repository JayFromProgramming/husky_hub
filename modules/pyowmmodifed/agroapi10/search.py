...
class SatelliteImagerySearchResultSet:
    ...
    is a `pyowmmodifed.agroapi10.imagery.MetaImage` subtype instance

    """

    def __init__(self, polygon_id, list_of_dict, query_timestamp):
        """
        Parses raw data dict into a list of `pyowmmodifed.agroapi10.imagery.MetaImage` subtypes instances and stores that
        ...
        :returns: a `pyowmmodifed.agroapi10.imagery.SatelliteImagerySearchResultSet` instance or an exception is parsing fails
    ...
    def all(self):
        ...
        :returns: a list of `pyowmmodifed.agroapi10.imagery.MetaImage` instances
    ...
    def with_img_type(self, image_type):
        ...
        :param image_type: the desired image type (valid values are provided by the
            `pyowmmodifed.commons.enums.ImageTypeEnum` enum)
        :type image_type: `pyowmmodifed.commons.databoxes.ImageType` instance
        :returns: a list of `pyowmmodifed.agroapi10.imagery.MetaImage` instances
    ...
    def with_preset(self, preset):
        ...
        :param preset: the desired image preset (valid values are provided by the
            `pyowmmodifed.agroapi10.enums.PresetEnum` enum)
        :type preset: str
        :returns: a list of `pyowmmodifed.agroapi10.imagery.MetaImage` instances
