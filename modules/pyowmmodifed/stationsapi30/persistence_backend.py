...
class PersistenceBackend:   # pragma: no cover
    ...
    def load_to_buffer(self):
        """
        Reads meteostation measurement data into a *pyowmmodifed.stationsapi30.buffer.Buffer*
        object.

        :returns: a *pyowmmodifed.stationsapi30.buffer.Buffer* instance
    ...
    def persist_buffer(self, buffer):
        """
        Saves data contained into a *pyowmmodifed.stationsapi30.buffer.Buffer* object
        in a durable form.
...
class JSONPersistenceBackend(PersistenceBackend):
    ...
    *pyowmmodifed.stationsapi30.measurement.Measurement* object.
