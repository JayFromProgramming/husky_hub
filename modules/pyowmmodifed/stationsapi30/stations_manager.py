...
class StationsManager:
    ...
    def get_stations(self):
        ...
        :returns: list of *pyowmmodifed.stationsapi30.station.Station* objects
    ...
    def get_station(self, id):
        ...
        :type id: str
        :returns: a *pyowmmodifed.stationsapi30.station.Station* object
    ...
    def create_station(self, external_id, name, lat, lon, alt=None):
        ...
        :type alt: float
        :returns: the new *pyowmmodifed.stationsapi30.station.Station* object
        """
    ...
    def update_station(self, station):
        ...
        *pyowmmodifed.stationsapi30.station.Station* object with all of its fields

        :param station: the *pyowmmodifed.stationsapi30.station.Station* object to be updated
        :type station: *pyowmmodifed.stationsapi30.station.Station*
    ...
    def delete_station(self, station):
        ...
        *pyowmmodifed.stationsapi30.station.Station*, along with all its related
        measurements

        :param station: the *pyowmmodifed.stationsapi30.station.Station* object to be deleted
        :type station: *pyowmmodifed.stationsapi30.station.Station*
    ...
    def send_measurement(self, measurement):
        ...
        :param measurement: the *pyowmmodifed.stationsapi30.measurement.Measurement*
          object to be posted
        :type measurement: *pyowmmodifed.stationsapi30.measurement.Measurement* instance
    ...
    def send_measurements(self, list_of_measurements):
        ...
        :param list_of_measurements: list of *pyowmmodifed.stationsapi30.measurement.Measurement*
          objects to be posted
        :type list_of_measurements: list of *pyowmmodifed.stationsapi30.measurement.Measurement*
          instances
        :returns: `None` if creation is successful, an exception otherwise
        """
    ...
    def get_measurements(self, station_id, aggregated_on, from_timestamp,
        ...
        :type limit: int
        :returns: list of *pyowmmodifed.stationsapi30.measurement.AggregatedMeasurement*
          objects
        """
    ...
    def send_buffer(self, buffer):
        ...
        :param buffer: the *pyowmmodifed.stationsapi30.buffer.Buffer* instance whose
          measurements are to be posted
        :type buffer: *pyowmmodifed.stationsapi30.buffer.Buffer* instance
        :returns: `None` if creation is successful, an exception otherwise
        """
