...
def humid_state_string(big_humid, little_humid, target):
    power = "Unknown"
    if not big_humid and not little_humid:
        power = "Off"
...
if os.path.isfile('Caches/Room_Coordination.json'):
    with open('Caches/Room_Coordination.json', 'r') as f:
    ...
    print("No Room Coordination File Found")
    sys.exit()
