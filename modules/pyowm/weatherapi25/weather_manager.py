...
from ..weatherapi25.uris import ROOT_WEATHER_API, PRO_WEATHER_API, OBSERVATION_URI, GROUP_OBSERVATIONS_URI, FIND_OBSERVATIONS_URI, \
...
class WeatherManager:
    ...
    def __init__(self, API_key, config):
        ...
        self.pro_client = HttpClient(API_key, config, PRO_WEATHER_API)
    ...
    def forecast_at_place(self, name, interval, limit=None):
        ...
        _, json_data = client.get_json(uri, params=params)
