...
from ..commons.enums import ImageTypeEnum
...
class HttpRequestBuilder:
    ...
    def build(self):
        if self.has_subdomains:
            return self.URL_TEMPLATE_WITH_SUBDOMAINS.format(self.schema, '', self.root, self.path), \
...
class HttpClient:
    ...
    def get_json(self, path, params=None, headers=None):
        ...
        url, params, headers, proxies = builder.build()  # URL param is horribly janked and might break other things
        try:
